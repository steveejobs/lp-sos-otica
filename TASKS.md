...
- [x] Criar seção "Qual lente combina com sua rotina?".
- [x] Adicionar CTA contextual para WhatsApp oficial.
- [x] Normalizar imagens da pasta `public/galeria sos/` para `public/assets/store/`.
- [x] Refinar seção "Por dentro da SOS Ótica" com fotos reais.
- [x] Substituir mapa abstrato por iframe real do Google Maps.
- [x] Reorganizar ordem da home.
- [x] Reduzir provas rápidas para três sinais comerciais.
- [x] Preservar hero, relógios, notícias, depoimentos, SEO/schema, WhatsApp e rota.
- [x] Ajustar copy para tom mais premium e humano.
- [x] Rodar `npm run lint`.
- [x] Rodar `npm run build`.
- [x] Gerar screenshots v17.
