...
const leftLensPath =
  "M0.052 0.218 C0.083 0.083 0.237 0.018 0.478 0.018 C0.689 0.018 0.893 0.084 0.957 0.224 C0.993 0.342 0.974 0.574 0.883 0.768 C0.775 0.918 0.591 0.968 0.357 0.924 C0.168 0.886 0.065 0.746 0.032 0.561 C0.011 0.431 0.017 0.317 0.052 0.218 Z";
const rightLensPath =
  ...
  return (
    ...
    >
      <path
        ...
        d="M217 349 C234 289 322 261 459 261 C580 261 696 290 733 351 C753 403 742 505 690 590 C629 656 524 678 390 659 C283 642 224 581 205 499 C193 442 197 392 217 349 Z"
      />
      <path
