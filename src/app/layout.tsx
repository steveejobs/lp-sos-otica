...
export const metadata: Metadata = {
  ...
  title: "SOS Ótica em Araguaína | Óculos pronto em até 40 minutos",
  description:
    "SOS Ótica em Araguaína-TO: óculos pronto em até 30 a 40 minutos, teste de visão, lentes, armações e atendimento rápido no Centro.",
  keywords: [
    "SOS Ótica",
    "ótica em Araguaína",
